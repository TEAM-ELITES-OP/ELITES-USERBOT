...
@SAVAGEbot.on(admin_cmd(pattern="sin ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="cos ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="tan ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="cosec ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="sec ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="cot ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="square ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@SAVAGEbot.on(admin_cmd(pattern="cube ?(.*)"))
@SAVAGEbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
