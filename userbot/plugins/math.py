...
@elitesbot.on(admin_cmd(pattern="sin ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="cos ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="tan ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="cosec ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="sec ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="cot ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="square ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@elitesbot.on(admin_cmd(pattern="cube ?(.*)"))
@elitesbot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
